        ...
        <Header/>
            <main className="bg-gray-700 pb-10 overflow-x-hidden">
                <div className="background">
                    <div className="text-container text-white text-center justify-center py-5 px-10 lg:w-4/5 md:w-screen mx-auto">
                        <p className="typing-text text-4xl font-extrabold mb-4" style={{ fontFamily: "'Dancing Script', cursive" }}>
                            Welcome to Real Babs Jalab and Fragrance Store!
                        </p>
