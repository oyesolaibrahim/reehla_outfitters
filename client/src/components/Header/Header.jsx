        ...
        <header className="bg-yellow-400 py-3 sm:px-10 xs:px-1 sticky md:-top-20 lg:-top-28 top top2 sm:-top-24 z-10">
                ...
                <div className="sm:flex md:flex-row lg:flex-row lg:space-x-5 md:space-x-0 sm:items-start md:items-center">
                    <div className={`md:flex-row md:flex sm:flex sm:flex-col lg:flex lg:flex-row xs:items-start sm:items-start md:p-0 xs:pt-36 sm:pt-36 xs:fixed sm:fixed sm:z xs:pl-10 sm:pl-10 xs:h-screen sm:h-screen md:h-1/6 xs:w-1/2 sm:w-1/2 xs:top-0 sm:top-0 md:static md:bg-transparent xs:bg-yellow-100 sm:bg-yellow-100 transition-all duration-1000 md:-space-x-12 md:items-center ${right ? "right" : "negative-right"}`}>
                        <div className="md:flex-row md:flex lg:flex lg:flex-row sm:flex-col sm:items-start md:items-center md:-space-x-5">
                            <Link to="/">
                                <h3 className="cursor-pointer font-bold sm:mb-5 md:mb-0 py-3 md:px-5 sm:px-0 sm:hover:text-red-800 md:hover:text-white">Home</h3>
                            </Link>
                            <Link to="/">
                                <h3 className="cursor-pointer min-w-32 font-bold sm:mb-5 md:mb-0 py-3 md:px-5 sm:hover:text-red-800 md:hover:text-white">About Us</h3>
                            </Link>
                            <Link to="/blog">
                                <h3 className="cursor-pointer lg:min-w-32 md:min-w-36 font-bold sm:mb-5 md:mb-0 py-3 sm:hover:text-red-800 md:px-5 md:pr-10 md:hover:text-white">Blog</h3>
                            </Link>
                        </div>
                        <div className="flex xs:m-0 md:flex-row lg:flex-row md:mr-10 sm:pl-5 sm:flex-col xs:flex xs:flex-col sm:items-start xs:items-start md:items-center">
                            <Link to="/signup">
                                <h3 className="cursor-pointer font-bold xs:mb-6 sm:mb-5 md:mb-0 hover:rounded-lg hover:bg-red-800 py-3 px-5 lg:mr-3 md:mr-3 hover:text-white">Signup</h3>
                            </Link>
                            <Link to="/login">
                                <h3 className="cursor-pointer font-bold sm:mb-5 md:mb-0 rounded-lg bg-red-800 py-3 px-5 text-white">Login</h3>
                            </Link>
                        </div>
                    </div>
            ...
            <div className="flex items-center md:justify-center sm:justify-start lg:space-x-48 md:space-x-10 sm:-space-x-16 xs:-space-x-16">
                <div className="flex sm:justify-center md:justify-center items-center lg:space-x-60 xs:space-x-2 sm:space-x-2">
                    <div className="flex sm:space-x-3 xs:space-x-0 sm:items-center xs:items-center xs:py-2 mt-10 rounded-lg bg-indigo-900 sm:w-60 xs:w-28 sm:py-3 xs:px-2 text-white">
                        <h3 className="font-bold uppercase xs:text-xs sm:ml-10 xs:ml-3">Start Shopping</h3>
                        <i className="fa fa-arrow-right" aria-hidden="true"></i>
                    </div>
                    <div className="flex sm:space-x-10 md:space-x-10 xs:space-x-3 mt-10 rounded-lg bg-indigo-900 sm:w-72 md:w-72 xs:w-52 py-3 sm:px-5 md:px-5 xs:px-2 text-white font-bold uppercase ml-10">
                        <div className="flex items-center space-x-2 relative">
                            ...
                            <div className={`sm:-z-10 xs:-z-10 absolute transition-all duration-1000 animate-popUp sm:top-10 xs:top-12 hidden sm:-left-36 xs:-left-28 rounded-lg bg-indigo-900 sm:w-52 md:w-52 xs:w-44 py-5 px-7 text-gray-200 ${jalabMenu ? "inline-block" : "hidden"}`}>
                                <Link to="/male/jalabs">
                        ...
                        <div className={`flex items-center space-x-2 relative ${right ? "sm:-z-10 xs:-z-10" : ""}`}>
                            ...
                            <div className={`sm:-z-10 xs:-z-10 absolute  transition-all duration-1000 animate-popUp  sm:top-10 xs:top-12 md:-right-36 sm:-left-16 xs:-left-5 rounded-lg bg-indigo-900 sm:w-52 md:w-52 xs:w-36 py-3 px-5 text-gray-200 ${fragranceMenu ? "inline-block" : "hidden"}`}>
                ...
                {adminToken ? (
                    <Link to="/jalabs/cart">
                        <button className={`cursor-pointer orders ${right ? "xs:-z-10" : ""} sm:-z-10 font-bold md:mb-0 rounded-lg bg-red-800 sm:py-3 sm:px-5 text-white sm:absolute sm:right-10 md:static xs:absolute`}>
                            Orders
                        </button>
                    </Link>
                ) : (
                    <div className={`relative md:left-0 sm:left-20 sm:top-5 cart cursor-pointer ${right ? "sm:-z-10 xs:-z-10" : ""}`}>
                        <div>
                            <Link to="/jalabs/cart">
                                ...
                                <div className="bg-red-800 rounded-full absolute top-0 left-5">
