        ...
        <header className="bg-muted-gold text-charcoal-gray sm:px-10 xs:px-1 sticky md:px-2 lg:px-10 md:-top-20 lg:-top-40 py-2 top top2 sm:-top-28 z-10">
            <div className="flex md:justify-center -pt-40 xs:mb-4 sm:justify-center items-center">
                ...
                <div className="flex items-center lg:mr-20 md:mr-0 sm:mr-20 xs:mr-16 space-x-2">
                    <input
                        className="px-5 text-green-800 search sm:py-4 lg:w-96 md:w-56 sm:w-80 rounded-lg xs:py-2"
                        placeholder="Search..."
                        value={searchQuery}
            ...
            <div className="flex items-center md:justify-center sm:justify-start lg:space-x-48 md:space-x-10 sm:-space-x-16 xs:-space-x-16">
                ...
                {adminToken ? (
                    ...
                    <div className={`relative md:left-0 text-gray-800 sm:left-20 sm:top-5 cart cursor-pointer ${right ? "sm:-z-10 xs:-z-10" : ""}`}>
                        <div>
                            <Link to="/jalabs/cart">
                                ...
                                <div className="bg-gray-100 rounded-full absolute top-0 left-5">
                                    <p className="text-amber-600 text-center sm:px-3 md:px-3 xs:px-3 py-1">{cartValue || 0}</p>
                                </div>
                            </Link>
                        </div>
                    </div>
