...
const Footer = () => {
  return (
    <footer className="bg-muted-gold text-charcoal-gray overflow-x-hidden py-6 sm:px-5 sm:space-x-10 xs:px-2 flex justify-between xs:flex-col-reverse items-center md:items-center">
