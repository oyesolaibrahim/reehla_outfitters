...
const UserSignUp = () => {
    ...
    return (
        <>
            <Header/>
            <main className="bg-soft-ivory min-h-screen py-10">
                <h3 className="error"></h3>
                <div className="text-white md:mb-24 xs:pt-10 xs:mb-10">
                </div>
                <div>
                    <div className="bg-soft-ivory border-2 border-muted-gold md:w-3/5 sm:w-screen py-10 xs:w-screen md:flex m-auto rounded-2xl pb-10 px-10">
