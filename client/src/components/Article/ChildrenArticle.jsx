...
import Emirate from "../../assets/shared/4a4ef75a1974415b9a3b6e0c3d19722d.jpg";
...
const ChildrenArticle = ({ childrenJalabs }) => {
  ...
  return (
    <>
      <div className="flex flex-wrap space-y-6 xs:justify-center sm:justify-center md:justify-between sm:items-center md:items-center">
        {objects?.map(jalab => (
